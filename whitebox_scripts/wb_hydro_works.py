...
#    """ Copy pipe features within map extent
#    
#    Parameters
#    ----------
#    in_pipes_paths : list
...
# Might want to make dist 20, since skipping buffer.
...
def pipes_to_raster_00(in_pipe_path, in_dem_path):
    ...
    output_path = out_file_00(in_pipe_path, "PIPR", "tif")
...
def process_pipe_vectors_00(in_pipe_paths, dist='10.0'):
    """Create a vector file of merged pipe files and extend lines by dist from each end.
    Parameters
    ----------
    in_pipe_paths : list
...
def process_dems_00(in_pipe_paths, in_dem_path, extend_dist='10', breach_dist='50'):
    ...
    breach_depressions_00(dem_01, breach_dist)
